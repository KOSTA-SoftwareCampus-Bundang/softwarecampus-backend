...
class LoginIntegrationTest {
        ...
        private com.softwarecampus.backend.service.user.email.EmailVerificationService emailVerificationService;
        ...
        void setUp() {
                // 이메일 인증 통과 처리
                org.mockito.Mockito
                                .when(emailVerificationService.isEmailVerified(org.mockito.ArgumentMatchers.anyString(),
                                                org.mockito.ArgumentMatchers.any()))
                                .thenReturn(true);

                // Redis Mock 설정 (HashMap 사용)
                ...
                org.mockito.Mockito.when(valueOperations.get(org.mockito.ArgumentMatchers.anyString()))
                                .thenAnswer(invocation -> redisMap.get(invocation.getArgument(0)));

                org.mockito.Mockito.doAnswer(invocation -> {
                        redisMap.put(invocation.getArgument(0), invocation.getArgument(1));
                        return null;
        ...
        void scenario_SignupAndLogin_Success() throws Exception {
                ...
                mockMvc.perform(post("/api/auth/login")
                                ...
                                .andExpect(jsonPath("$.expiresIn").value(1800)) // 30분 = 1800초
