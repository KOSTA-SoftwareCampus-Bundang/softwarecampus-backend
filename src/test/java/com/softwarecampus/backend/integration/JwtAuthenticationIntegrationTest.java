...
class JwtAuthenticationIntegrationTest {
        ...
        void setUp() {
                ...
                jdbcTemplate.update("DELETE FROM account WHERE email = ?", "test@example.com");
        ...
        void authenticateWithAcademyAccount() throws Exception {
                // given
                jdbcTemplate.execute("SET FOREIGN_KEY_CHECKS = 0");
                jdbcTemplate.update("DELETE FROM account WHERE email = ?", "academy@example.com");
                jdbcTemplate.execute("SET FOREIGN_KEY_CHECKS = 1");
        ...
        void authenticateWithAdminAccount() throws Exception {
                // given
                jdbcTemplate.execute("SET FOREIGN_KEY_CHECKS = 0");
                jdbcTemplate.update("DELETE FROM account WHERE email = ?", "admin@example.com");
                jdbcTemplate.execute("SET FOREIGN_KEY_CHECKS = 1");
