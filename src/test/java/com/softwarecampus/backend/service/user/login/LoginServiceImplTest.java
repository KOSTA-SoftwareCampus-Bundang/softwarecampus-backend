...
class LoginServiceImplTest {
    ...
    void login_Success_User() {
        // given
        when(accountRepository.findByEmailAndIsDeletedFalse(validRequest.email()))
        ...
        // verify
        verify(accountRepository).findByEmailAndIsDeletedFalse(validRequest.email());
    ...
    void login_Success_Academy() {
        ...
        when(accountRepository.findByEmailAndIsDeletedFalse(academyRequest.email()))
    ...
    void login_Fail_PendingAcademy() {
        ...
        when(accountRepository.findByEmailAndIsDeletedFalse(pendingRequest.email()))
    ...
    void login_Fail_RejectedAcademy() {
        ...
        when(accountRepository.findByEmailAndIsDeletedFalse(rejectedRequest.email()))
